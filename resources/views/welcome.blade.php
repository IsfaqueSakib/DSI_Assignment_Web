					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="#">Shop<i class="active"></i></a>
                                    
                                </li> 
								<li><a href="#">Blog<i class="active"></i></a>
					...
					<div class="features_items"><!--features_items-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/home/fisher.jpg" alt="" />
											<h2><span>&#2547;</span> 11,840</h2>
											<p>Fisher</p>
											<a href="https://www.amazon.com/Fisher-Price-Soothing-Motions-Bassinet-Windmill/dp/B01K7VHW0C/?_encoding=UTF8&pd_rd_w=1c54g&pf_rd_p=569948c0-0104-4e94-8b17-3cb0be30a6e8&pf_rd_r=R6G431EA2F0T74VAE19E&pd_rd_r=1e22e775-b9cf-4f07-8342-d3a717f6a1db&pd_rd_wg=W2mXC&ref_=pd_gw_unk" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/home/shirt.jpg" alt="" />
										<h2><span>&#2547;</span> 1,360</h2>
										<p>Kenneth Cole Unlisted Men's Dress Shirt</p>
										<a href="https://www.amazon.com/Kenneth-Cole-Unlisted-Shirts-Sleeve/dp/B0762T3BHV/?_encoding=UTF8&pd_rd_w=ZF9xy&pf_rd_p=7eac7129-d774-4c12-bb48-89122ac8b50a&pf_rd_r=R6G431EA2F0T74VAE19E&pd_rd_r=1e22e775-b9cf-4f07-8342-d3a717f6a1db&pd_rd_wg=W2mXC&ref_=pd_gw_unk&th=1" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/home/watch.jpg" alt="" />
										<h2><span>&#2547;</span> 13,500</h2>
										<p>Garmin Forerunner 235, GPS Running Watch, Black</p>
										<a href="https://www.amazon.com/Garmin-Forerunner-Running-Watch-Black/dp/B0160BC1FO/?_encoding=UTF8&pd_rd_w=U0s18&pf_rd_p=61a95fae-e859-4f27-858a-6146c1ae863a&pf_rd_r=R6G431EA2F0T74VAE19E&pd_rd_r=1e22e775-b9cf-4f07-8342-d3a717f6a1db&pd_rd_wg=W2mXC&ref_=pd_gw_unk" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/home/doll.jpg" alt="" />
										<h2><span>&#2547;</span> 840</h2>
										<p>Bedtime Originals Choo Choo Express Plush Elephant - Humphrey</p>
										<a href="https://www.amazon.com/Bedtime-Originals-Express-Plush-Elephant/dp/B00GHAGGOG/?_encoding=UTF8&pd_rd_w=WSzey&pf_rd_p=0a0fec03-b408-45eb-8e57-18d0d31850f9&pf_rd_r=R6G431EA2F0T74VAE19E&pd_rd_r=1e22e775-b9cf-4f07-8342-d3a717f6a1db&pd_rd_wg=W2mXC&ref_=pd_gw_unk" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/home/mobile.jpg" alt="" />
										<h2><span>&#2547;</span> 42,200</h2>
										<p>OnePlus 8 Glacial Green</p>
										<a href="https://www.amazon.com/OnePlus-Glacial-Unlocked-Android-Smartphone/dp/B08723759H/ref=sr_1_10?dchild=1&keywords=mobile&qid=1616790080&sr=8-10" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/home/keyboard.jpg" alt="" />
										<h2><span>&#2547;</span> 4,058</h2>
										<p>Razer Cynosa Chroma Gaming Keyboard</p>
										<a href="https://www.amazon.com/Razer-Cynosa-Chroma-Gaming-Keyboard/dp/B075KMZ4MX/ref=sr_1_4?dchild=1&keywords=keyboard&qid=1616790262&sr=8-4" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
